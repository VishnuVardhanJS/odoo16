            ...
            for exception in exception_ids:
                ...
                if exception.based_on == 'Products':
                    ...
                    name = 'Commission Exception' + ' ' + 'with' + ' "' + tools.ustr(
                        exception.based_on_2) + ' "' + ' ' + 'for' + ' ' + tools.ustr(
                        exception.based_on) + ' "' + tools.ustr(exception.product_id.name) + '" @' + tools.ustr(
    ...
    def get_partner_commission(self, commission_brw, order):
        ...
        for line in order.order_line:
            ...
            if (order.user_id and order.user_id.id in sales_person_list) and order.partner_id.is_affiliated == True:
                ...
                name = 'Partner Based commission " ' + tools.ustr(commission_brw.name) + ' (' + tools.ustr(
